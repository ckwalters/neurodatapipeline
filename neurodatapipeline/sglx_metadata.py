...
def CoordsToKSChanMapJSON(meta, chans, xCoord, yCoord, connected, shankInd, shankSep, baseName, savePath, buildPath): 
...
def MetaToCoords(metaFullPath: Path, outType: int, badChan=np.zeros((0),dtype='int'),
                 destFullPath:Path=None, showPlot=False):
    """
